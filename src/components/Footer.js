    ...
    <div className="footer">
      ...
      <div className="footer-content">
        <div className="col col1">
          <h3>Gandhaar 2025</h3>
          <p>MKSSS's Cummins College of Engineering for Women, Karve Nagar, Pune. 411-052</p>
        </div>
        <div className="col col2">
          ...
          <div className="contact-icons">
            ...
            >
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill-rule="evenodd" clip-rule="evenodd" image-rendering="optimizeQuality" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" 
              viewBox="0 0 13333.33 13333.33" id="instagram">
  <defs>
